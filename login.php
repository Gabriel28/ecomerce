	...
	<header>
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="HOT">
								<a href="produtos.html"> Todos os Games</a>
							</li>
		...
		<div class="menu-mobile">
			...
			<ul class="main-menu-m">
				<li>
					<a href="index.html">Home - BRAZIL GAMING WORLD </a>
				...
				<li>
					<a href="produtos.html" class="label1 rs1" data-label1="HOT">Todos os Games</a>
				</li>
